  ...
  const ProductPage = () => {
    ...
    const { data, loading ,toggleFavorite , favorites } = useContext(ContextApi);
                 ...
                 onToggle={() => toggleFavorite(product.id)
                  ...
                  <div className="p-3 md:p-4">
                    ...
                    <div className="flex gap-2 ">
                      <button className="flex-1 cursor-pointer bg-black  text-white text-xs md:text-sm py-2 px-3 rounded-md active:scale-95">
                        Add to Cart
                      </button>
                      <Link
